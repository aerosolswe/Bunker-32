...
public class Grid : MonoBehaviour {
    ...
    private static Color walkableColor = new Color(1, 1, 1, 0.25f);
    private static Color unwalkableColor = new Color(1, 0, 0, 0.25f);
    private static Color pathColor = new Color(1, 1, 0, 0.25f);
    private static Color playerColor = new Color(0.2f, 0.2f, 1, 0.25f);
    ...
    void CreateGrid() {
        ...
        for(int x = 0; x < gridSizeX; x++) {
            for (int y = 0; y < gridSizeY; y++) {
                ...
                Collider2D coll = Physics2D.OverlapCircle(worldPoint, nodeRadius, unwalkableMask);

                bool walkable = coll == null;
